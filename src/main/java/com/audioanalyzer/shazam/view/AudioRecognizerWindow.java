package com.audioanalyzer.shazam.view;

import com.audioanalyzer.shazam.model.Complex;
import com.audioanalyzer.shazam.model.DataPoint;
import com.audioanalyzer.shazam.model.FFT;
...
public class AudioRecognizerWindow extends JFrame {
 ...
 /*
 private void sampleOriginal(long songId, boolean isMatching)
    ...
    private void sampleRecord(long songId, boolean isMatching)
            throws LineUnavailableException, IOException,
            UnsupportedAudioFileException {
  ...
  */
    ...
    private void makeSpectrum(ByteArrayOutputStream out, long songId, boolean isMatching) {
        ...
        System.out.println(amountPossible + " chucks");
    ...
    public void createWindow() {
        ...
        fileTextField.setText("C:\\Users\\tmoro\\Music\\iTunes\\iTunes Media\\Music\\Katy Perry\\Witness\\" +
                "04 Swish Swish (feat. Nicki Minaj).mp3");
